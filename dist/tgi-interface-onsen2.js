/**---------------------------------------------------------------------------------------------------------------------
 * tgi-interface-onsen2/lib/_packaging/lib-header
 **/
(function () {
"use strict";
var root = this;
...
Onsen2Interface.prototype.renderPanelBody = function (panel, command) {
  ...
  function renderContents() {
    ...
    function renderText(onsList, text) {
      ...
      listItem.innerHTML = ' renderText: ' + text;
      // var textDiv = addEle(listItem , 'div');
    ...
    function renderAttribute(onsList, attribute, mode) {
      var listItem = addEle(onsList, 'ons-list-item');
      listItem.innerHTML = ' renderAttribute: ' + attribute;
      return;
      {
        var daList;
        var daItems;
...
/**---------------------------------------------------------------------------------------------------------------------
 * tgi-interface-onsen2/lib/_packaging/lib-footer
 **/
  /* istanbul ignore next */
